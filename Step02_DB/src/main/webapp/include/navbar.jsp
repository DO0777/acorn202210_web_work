...
<%
	...
	String thisPage=request.getParameter("thisPagr"); // "index" | "todo" | "list"
%>
	...
	<nav class="navbar navbar-expand-md navbar-dark" style="background-color:#712cf9;">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					<li class="nav-item">
						<a class="nav-link" <%=thisPage.equals("todo") ? "active" : "" %> href="${pageContext.request.contextPath }/member/list.jsp">회원목록</a>
					</li>
					<li class="nav-item">
